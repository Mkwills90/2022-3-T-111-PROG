...
def get_equation() -> str:
    ...
    return input("Enter a chemical equation: ")
...
def compare_sides(left_set: set, right_set: set) -> None:
    ...
    if left_set == right_set:
        ...
        if missing_from_right_side:
            print(
                f"The following elements appear on the left side but not the right:",
                end="\n ",
            )
        ...
        if missing_from_left_side:
            print(
                f"The following elements appear on the right side but not the left:",
                end="\n ",
            )
